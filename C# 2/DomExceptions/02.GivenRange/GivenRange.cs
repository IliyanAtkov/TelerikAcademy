...
// the method should throw an exception. Using this method write a program
...
class GivenRange
{
    ...
    static string NumberText(int numbers)
    {
    ...
    static int ReadNumber(int start, int end)
    {
        ...
        try
        {
            Console.Write("Enter {2} number between {0} and {1}: ", start, end, NumberText(counter + 1));
