...
class GSM
{
    ...
    {
        string result = string.Format("Model: {0}; Manufacturer: {1}; Price: {2}; Owner: {3}; Battery: {4}; Display {5}", this.model, this.manufacturer, this.price, this.battery, this.display);
        return result;
    }
}
