...
class GSMTest
{
    public static void Main()
    {
        ...
        GSMs[0] = new GSM("Xperia", "Samsung", 459.99, "Rafael");
        Battery litiumBattery = new Battery("Normal", 123, 20.5, BatteryType.LiIon);
        GSMs[1] = new GSM("W595", "Sony Erricson", 456, "Daniel", litiumBattery);
        Display big = new Display(8.4, 3000);
        GSMs[2] = new GSM("Galaxy Beam", "Samsung", 678, "Cecilia", litiumBattery, big);
