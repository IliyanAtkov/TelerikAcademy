...
public class SimpleMathExam : Exam
{
    public SimpleMathExam(int problemsSolved)
    {
        if (problemsSolved < 0)
        {
            throw new ArgumentOutOfRangeException("Problems solved cannot be less than zero");
        }

        if (problemsSolved > 10)
        {
            throw new ArgumentOutOfRangeException("Problems solved cannot be higher than ten");
        }
