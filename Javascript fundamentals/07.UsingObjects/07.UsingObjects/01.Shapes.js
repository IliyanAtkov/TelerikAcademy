...
console.log("The distance between the ponts is " + calculateDistanceBetweenTwoPoints(line1.point, line1.point2));
...
console.log("The three lines can form triangle => " + canFormTriangle(lenghtLine1, lenghtLine2, lenghtLine3))
